...
class App(CTk.CTk):
    def __init__(self):
        ...
        self.password_length_slider = CTk.CTkSlider(master=self.settings_frame, from_=0, to=25, number_of_steps=100,
        ...
        self.appearance_mode_option_menu.grid(row=3, column=0, columnspan=4, pady=(20, 10))
    ...
    def set_password(self):
        ...
        self.entry_password.insert(0,password.create_new(lenght=int(self.password_length_slider.get()),
